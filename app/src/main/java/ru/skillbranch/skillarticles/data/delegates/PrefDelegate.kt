    ...
    operator fun provideDelegate(
        ...
        return object : ReadWriteProperty<PrefManager, T> {
            ...
            override fun setValue(thisRef: PrefManager, property: KProperty<*>, value: T) {
                ...
                // need set value in coroutine scope
            ...
            override fun getValue(thisRef: PrefManager, property: KProperty<*>): T {
                if (_storedValue == null) {
                    ...
                    // На потоке где был вызван выполнит какую то корутину и заблокирует поток до окончания
                    // выполнения данного запроса (корутины), считываем с физического файла 1 раз при первом обращении
